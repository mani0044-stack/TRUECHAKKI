    ...
    <footer className="bg-[#351D0F] text-[#FAF4E8] pt-16 pb-8 border-t-4 border-[#9A6B29] text-center md:text-left relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-[#FAF4E8]/15">
          ...
          {/* Col 4: Social Connect Buttons */}
          <div className="space-y-4 flex flex-col items-center md:items-start">
            <h3 className="font-serif text-lg font-semibold text-[#CFB57F] border-b border-[#FAF4E8]/10 pb-2 w-full text-center md:text-left">
              Connect With Us
            </h3>
            <p className="text-xs text-[#FAF4E8]/80 max-w-sm text-center md:text-left leading-relaxed">
              Have a question? Chat with us directly on WhatsApp, Instagram, or Facebook with a pre-typed inquiry.
            </p>

            <div className="space-y-3 w-full max-w-sm pt-1">
              {/* WhatsApp Button */}
              <button
                onClick={handleWhatsAppClick}
                className="w-full px-4 py-2.5 bg-[#25D366]/15 hover:bg-[#25D366]/25 border border-[#25D366]/40 hover:border-[#25D366] text-[#FAF4E8] rounded-2xl flex items-center justify-center md:justify-start gap-3 transition-all group shadow-xs hover:shadow-md cursor-pointer"
              >
                <div className="w-8 h-8 rounded-full bg-[#25D366] flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-[#FAF4E8] group-hover:text-[#25D366] transition-colors">Chat on WhatsApp</div>
                  <div className="text-[10px] text-[#FAF4E8]/60">Auto-types inquiry message</div>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-2.5 bg-gradient-to-r from-[#833AB4]/15 via-[#FD1D1D]/15 to-[#FCB045]/15 hover:from-[#833AB4]/30 hover:via-[#FD1D1D]/30 hover:to-[#FCB045]/30 border border-[#E1306C]/40 hover:border-[#E1306C] text-[#FAF4E8] rounded-2xl flex items-center justify-center md:justify-start gap-3 transition-all group shadow-xs hover:shadow-md cursor-pointer"
              >
                <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-[#FD1D1D] via-[#E1306C] to-[#833AB4] flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <div className="text-left">
                  <div className="text-xs font-bold text-[#FAF4E8] group-hover:text-[#E1306C] transition-colors">Message on Instagram</div>
                  <div className="text-[10px] text-[#FAF4E8]/60">Auto-copies inquiry message</div>
                </div>
              </button>
              ...
              <button
                ...
                className="w-full px-4 py-2.5 bg-[#1877F2]/15 hover:bg-[#1877F2]/25 border border-[#1877F2]/40 hover:border-[#1877F2] text-[#FAF4E8] rounded-2xl flex items-center justify-center md:justify-start gap-3 transition-all group shadow-xs hover:shadow-md cursor-pointer"
              >
                <div className="w-8 h-8 rounded-full bg-[#1877F2] flex items-center justify-center text-white shrink-0 group-hover:scale-110 transition-transform">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </div>
                <div className="text-left">
                  <div className="text-xs font-bold text-[#FAF4E8] group-hover:text-[#1877F2] transition-colors">Connect on Facebook</div>
                  <div className="text-[10px] text-[#FAF4E8]/60">Auto-types inquiry message</div>
                </div>
              </button>
            </div>
