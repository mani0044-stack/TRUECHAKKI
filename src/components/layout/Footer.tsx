          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5 pt-1">
              ...
              <button
                ...
                className="px-3.5 py-2 bg-[#25D366]/15 hover:bg-[#25D366] text-[#FAF4E8] hover:text-white border border-[#25D366]/40 rounded-full flex items-center gap-2 text-xs font-medium transition-all cursor-pointer shadow-xs"
              ...
              <button
                ...
                className="px-3.5 py-2 bg-[#E1306C]/15 hover:bg-[#E1306C] text-[#FAF4E8] hover:text-white border border-[#E1306C]/40 rounded-full flex items-center gap-2 text-xs font-medium transition-all cursor-pointer shadow-xs"
                title="Message on Instagram"
              >
                <svg className="w-4 h-4 fill-current text-[#E1306C] group-hover:text-white" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="px-3.5 py-2 bg-[#1877F2]/15 hover:bg-[#1877F2] text-[#FAF4E8] hover:text-white border border-[#1877F2]/40 rounded-full flex items-center gap-2 text-xs font-medium transition-all cursor-pointer shadow-xs"
