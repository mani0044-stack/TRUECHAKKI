          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            ...
            <div className="space-y-2 text-xs text-[#FAF4E8]/70 pt-2 flex flex-col items-center md:items-start">
              ...
              <div className="flex items-center justify-center md:justify-start gap-2">
                ...
                <span>truechakki@gmail.com</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5 pt-1">
              ...
              <button
                ...
                className="group px-3.5 py-2 bg-[#FAF4E8]/10 hover:bg-[#9A6B29] text-[#FAF4E8] hover:text-white border border-[#CFB57F]/30 hover:border-[#9A6B29] rounded-full flex items-center gap-2 text-xs font-medium transition-all cursor-pointer shadow-xs"
                title="Chat on WhatsApp"
              >
                <svg className="w-4 h-4 fill-current text-[#CFB57F] group-hover:text-white transition-colors" viewBox="0 0 24 24">
